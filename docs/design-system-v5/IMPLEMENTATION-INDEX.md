...
- `node scripts/capture-v5-evidence.mjs` — **26 real, authenticated screenshots** including a live print-preview of a real submitted report, stored under `INSPECTION_DOCS_ROOT`.
