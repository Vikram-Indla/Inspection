...
| 8 | Official report and print | Substantial — 3 real print-CSS gaps fixed and confirmed live via a real print-preview screenshot of a submitted report. Page-number/running-footer documented as a platform constraint. 5-layer content-model rebuild deliberately deferred — legally-significant document, needs its own dedicated pass. | 420f3f8, 18f5ebc |
