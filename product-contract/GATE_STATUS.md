...
| G10 Verification | PASS (2026-07-16) | Exact release candidate: 291/291 PASS (4 setup + 287 application), 0 failed/skipped/excluded; production build/typecheck PASS; cross-persona golden journey, arrival outbox/readback, review concurrency, negative auth/offline and RTL/theme/responsive matrices pass. |
| G11 Hardening | OPEN | Credential rotation and historical-secret response; migration-history hardening; Seoul→Frankfurt region decision; provider adapters; 18 upstream AC partials; CD-031 authoritative wiring map/privacy/preflight; asset/geographic confirmations and sponsor runtime acceptance |
