...
|---|---|---|---|---|---|---|---|---|
| SB01 | Executive end-to-end | All personas (umbrella) | 493 | 14 | 460 | 19 | 0 | umbrella — tracks whole platform (493 rows) |
...
| SB07 | Physical Start Journey | Inspector (iPad) | 30 | 0 | 27 | 3 | 0 | mostly coded; some legs read-only |
...
| SB14 | Journey Telemetry / Exception | Inspector (iPad) | 30 | 0 | 27 | 3 | 0 | mostly coded; some legs read-only |
...
| SB19 | Web + Inspector IA | All channels (umbrella) | 493 | 14 | 460 | 19 | 0 | umbrella — tracks whole platform (493 rows) |
| SB20 | Architecture / Integrations / Security Blueprint | Platform (umbrella) | 493 | 14 | 460 | 19 | 0 | umbrella — tracks whole platform (493 rows) |
