# M2 — Planning and Visits

Task: `TASK-WEB-ADMIN-PHASE1-PLAN-001-M2`
Change control: `CC-WEB-ADMIN-PHASE1-001`

## Authority and scope

- Routes: `/planning/**;/visits/**`
- Designs: SAQEEL Planning.dc.html;SAQEEL Planning Identity.dc.html;SAQEEL Visits.dc.html
- Requirements: CR-001..CR-098
- Depends on: F0

## Exact file ownership

- `apps/web/src/app/(app)/planning/bulk/page.tsx`
- `apps/web/src/app/(app)/planning/bulk/review/page.tsx`
...
- `apps/web/src/app/(app)/planning/single/page.tsx`
- `apps/web/src/app/(app)/visits/[id]/page.tsx`
- `apps/web/src/app/(app)/visits/calendar/page.tsx`
- `apps/web/src/app/(app)/visits/map/page.tsx`
- `apps/web/src/app/(app)/visits/page.tsx`
- `apps/web/src/app/(app)/visits/workload/page.tsx`
...
Completion command template: `npm run typecheck && npm run build && npx playwright test <focused-m2-specs> && node scripts/validate_web_admin_phase1.mjs`
