# M1 — Executive and Business Dashboard
...
- Routes: `/dashboard`
- Designs: SAQEEL Executive Overview.html;SAQEEL Web Dashboard.dc.html
...
Completion command template: `npm run typecheck && npm run build && npx playwright test <focused-m1-specs> && node scripts/validate_web_admin_phase1.mjs`
