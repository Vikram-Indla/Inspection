...
| `app/(app)/admin/_components/AdminDestinationFrame.tsx` | `components/app-shell/shell-page-frame/shell-page-frame` | 2026-08-16 | `/admin/integrations`, `/admin/localization`, `/admin/packages`, `/admin/risk` — **`/admin/access` migrated (T-122)** | 0-imports |
