...
import arAdminHome from "./locales/ar/admin-home.json";
import arAdminDashboardConfig from "./locales/ar/admin-dashboard-config.json";
import arAdminItems from "./locales/ar/admin-items.json";
...
import arAdminTemplates from "./locales/ar/admin-templates.json";
...
import arAdminRisk from "./locales/ar/admin-risk.json";
...
import enAdminHome from "./locales/en/admin-home.json";
import enAdminDashboardConfig from "./locales/en/admin-dashboard-config.json";
import enAdminItems from "./locales/en/admin-items.json";
...
import enAdminTemplates from "./locales/en/admin-templates.json";
...
import enAdminRisk from "./locales/en/admin-risk.json";
...
export type Messages = {
  ...
  readonly adminHome: typeof enAdminHome;
  readonly adminDashboardConfig: typeof enAdminDashboardConfig;
  readonly adminItems: typeof enAdminItems;
  ...
  readonly adminTemplates: typeof enAdminTemplates;
  ...
  readonly adminRisk: typeof enAdminRisk;
  ...
  readonly tasks: typeof enTasks;
  readonly visits: typeof enVisits;
};

const MESSAGES: Readonly<Record<Locale, Messages>> = {
  en: { adminAudit: enAdminAudit, adminSecurityAccess: enAdminSecurityAccess, adminDevices: enAdminDevices, adminComplianceRequests: enAdminComplianceRequests, adminDelegation: enAdminDelegation, adminEnforcementRecommendations: enAdminEnforcementRecommendations, adminWorkflows: enAdminWorkflows, adminIntegrations: enAdminIntegrations, adminFactoryData: enAdminFactoryData, adminGis: enAdminGis, adminHome: enAdminHome, adminDashboardConfig: enAdminDashboardConfig, adminItems: enAdminItems, adminNotifications: enAdminNotifications, adminOperations: enAdminOperations, adminSenaiData: enAdminSenaiData, adminTemplates: enAdminTemplates, adminAccess: enAdminAccess, adminLocalization: enAdminLocalization, adminPackages: enAdminPackages, adminPlanningExpiry: enAdminPlanningExpiry, adminPlanningLookups: enAdminPlanningLookups, adminPlanningStatus: enAdminPlanningStatus, adminRisk: enAdminRisk, adminRiskModels: enAdminRiskModels, analytics: enAnalytics, approvals: enApprovals, common: enCommon, dashboard: enDashboard, enforcement: enEnforcement, execution: enExecution, factories: enFactories, factoriesCr: enFactoriesCr, fieldCompleted: enFieldCompleted, fieldDrafts: enFieldDrafts, fieldEstablishments: enFieldEstablishments, fieldHome: enFieldHome, fieldMyTasks: enFieldMyTasks, fieldNotifications: enFieldNotifications, fieldReports: enFieldReports, fieldSettings: enFieldSettings, fieldUnregistered: enFieldUnregistered, fieldVisits: enFieldVisits, login: enLogin, notifications: enNotifications, operations: enOperations, planning: enPlanning, profile: enProfile, regulations: enRegulations, reviews: enReviews, shell: enShell, tasks: enTasks, visits: enVisits },
  ar: { adminAudit: arAdminAudit, adminSecurityAccess: arAdminSecurityAccess, adminDevices: arAdminDevices, adminComplianceRequests: arAdminComplianceRequests, adminDelegation: arAdminDelegation, adminEnforcementRecommendations: arAdminEnforcementRecommendations, adminWorkflows: arAdminWorkflows, adminIntegrations: arAdminIntegrations, adminFactoryData: arAdminFactoryData, adminGis: arAdminGis, adminHome: arAdminHome, adminDashboardConfig: arAdminDashboardConfig, adminItems: arAdminItems, adminNotifications: arAdminNotifications, adminOperations: arAdminOperations, adminSenaiData: arAdminSenaiData, adminTemplates: arAdminTemplates, adminAccess: arAdminAccess, adminLocalization: arAdminLocalization, adminPackages: arAdminPackages, adminPlanningExpiry: arAdminPlanningExpiry, adminPlanningLookups: arAdminPlanningLookups, adminPlanningStatus: arAdminPlanningStatus, adminRisk: arAdminRisk, adminRiskModels: arAdminRiskModels, analytics: arAnalytics, approvals: arApprovals, common: arCommon, dashboard: arDashboard, enforcement: arEnforcement, execution: arExecution, factories: arFactories, factoriesCr: arFactoriesCr, fieldCompleted: arFieldCompleted, fieldDrafts: arFieldDrafts, fieldEstablishments: arFieldEstablishments, fieldHome: arFieldHome, fieldMyTasks: arFieldMyTasks, fieldNotifications: arFieldNotifications, fieldReports: arFieldReports, fieldSettings: arFieldSettings, fieldUnregistered: arFieldUnregistered, fieldVisits: arFieldVisits, login: arLogin, notifications: arNotifications, operations: arOperations, planning: arPlanning, profile: arProfile, regulations: arRegulations, reviews: arReviews, shell: arShell, tasks: arTasks, visits: arVisits },
};
