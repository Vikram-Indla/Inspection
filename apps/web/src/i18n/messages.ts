...
import arAdminAudit from "./locales/ar/admin-audit.json";
import arAdminSecurityAccess from "./locales/ar/admin-security-access.json";
import arAdminDevices from "./locales/ar/admin-devices.json";
...
import arFactoriesCr from "./locales/ar/factories-cr.json";
...
import enAdminAudit from "./locales/en/admin-audit.json";
import enAdminSecurityAccess from "./locales/en/admin-security-access.json";
import enAdminDevices from "./locales/en/admin-devices.json";
...
import enFactoriesCr from "./locales/en/factories-cr.json";
...
export type Messages = {
  ...
  readonly adminAudit: typeof enAdminAudit;
  readonly adminSecurityAccess: typeof enAdminSecurityAccess;
  readonly adminDevices: typeof enAdminDevices;
  ...
  readonly factoriesCr: typeof enFactoriesCr;
