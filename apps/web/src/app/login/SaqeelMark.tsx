    ...
    <svg className={className} viewBox="0 0 48 48" role="img" aria-label="Saqeel"
      ...
      <defs>
        <radialGradient id="saqeel-beacon" cx="50%" cy="50%" r="50%">
          <stop offset="0" stopColor="var(--status-info)" stopOpacity="0.95" />
          <stop offset="0.55" stopColor="var(--status-info)" stopOpacity="0.55" />
          <stop offset="1" stopColor="var(--status-info)" stopOpacity="0" />
        </radialGradient>
      </defs>
      ...
      <path d="M24 2.5 L28 22 L24 26 L20 22 Z" fill="var(--action-primary)" />
      <path d="M24 45.5 L20 26 L24 22 L28 26 Z" fill="var(--action-primary-hover)" />
      <path d="M2.5 24 L22 20 L26 24 L22 28 Z" fill="var(--action-primary-hover)" />
      <path d="M45.5 24 L26 28 L22 24 L26 20 Z" fill="var(--action-primary)" />

      {/* inspection beacon: cyan glow + core + crosshair ticks */}
      <circle cx="24" cy="24" r="9" fill="url(#saqeel-beacon)" />
      <circle cx="24" cy="24" r="4.4" fill="none" stroke="var(--status-info)" strokeWidth="1.6" />
      <path d="M24 15.5 v3.4 M24 29.1 v3.4 M15.5 24 h3.4 M29.1 24 h3.4"
        stroke="var(--status-info)" strokeWidth="1.4" />
