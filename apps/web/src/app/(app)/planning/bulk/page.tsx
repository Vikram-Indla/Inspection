...
export default async function BulkPlanning({ searchParams }: { searchParams: Promise<{ ct?: string; cf?: string | string[]; co?: string | string[]; cv?: string | string[]; combine?: string }> }) {
  ...
  const strings: BulkFormStrings = {
    ...
    mixedAckTitle: t("plan.bulk.mixedAckTitle", "Confirm the eligible subset"),
    mixedAckBody: t("plan.bulk.mixedAckBody", "This page contains {eligible} eligible factories and {excluded} excluded factories. Excluded factories will not continue to review."),
    mixedAckLabel: t("plan.bulk.mixedAckLabel", "I acknowledge that {excluded} excluded factories will not be included."),
