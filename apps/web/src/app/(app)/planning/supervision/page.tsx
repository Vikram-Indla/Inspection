...
export default async function SupervisionPage() {
  ...
  if (access.error) return <Shell current="/planning" title="Supervision queue"><EmptyState glyph="⚠" title="Supervision data unavailable" body="The queue could not be loaded. Nothing was changed." /></Shell>;
  ...
  if (requestRead.error || inspectorRead.error) return <Shell current="/planning" title="Supervision queue"><EmptyState glyph="⚠" title="Supervision data unavailable" body="The queue could not be loaded. Nothing was changed." /></Shell>;
