        ...
        <div className={styles.list}>
          <AssignmentTaskBrowser
            ...
            labels={{
              ...
              offline: tr("field.myTasks.offline", "Offline — cached assignment details remain available; writes will queue where supported.", "غير متصل — تبقى تفاصيل المهام المخزنة متاحة، وتوضع العمليات المدعومة في قائمة الانتظار."),
