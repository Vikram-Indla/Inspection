...
export default async function FactoryDataPage({ searchParams }: { searchParams: Promise<{ factory?: string }> }) {
  ...
  return <Shell current="/admin/integrations" title={t("admin.factoryData.title", "Factory data integration")} context={<span className="badge badge-info">P12</span>}>
