...
export default function MasterDataForms({ factoryId, representatives }: { factoryId: string; representatives: { id: string; full_name: string; active: boolean }[] }) {
  ...
  return <><div className="ax-grid">
    <form action={documentAction} className="panel stack" style={{ padding: "var(--ax-space-200)" }}>
    ...
    <form action={representativeAction} className="panel stack" style={{ padding: "var(--ax-space-200)" }}>
    ...
    <form action={productAction} className="panel stack" style={{ padding: "var(--ax-space-200)" }}>
    ...
    <form action={materialAction} className="panel stack" style={{ padding: "var(--ax-space-200)" }}>
  ...
  </div><section className="panel stack" style={{ padding: "var(--ax-space-200)", marginBlockStart: "var(--ax-space-200)" }}><h4>Representative status</h4>
