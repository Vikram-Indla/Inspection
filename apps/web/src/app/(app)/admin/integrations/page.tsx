...
export default async function IntegrationsPage() {
  ...
  return (
    <Shell current="/admin/integrations" title={t("mvp3.integrations.title", "Integration trust console")}
      ...
      <div className="row" style={{ marginBlock: "var(--ax-space-200)" }}><Link className="btn btn-secondary btn-touch" href="/admin/integrations/factory-data">Factory data integration and import</Link></div>
      ...
      <section className="panel stack" style={{ padding: "var(--ax-space-300)" }} aria-labelledby="integration-registry">
