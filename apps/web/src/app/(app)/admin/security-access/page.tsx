  ...
  return (
    <Shell current="/admin/security-access" title={t("mvp3.security.title", "Security posture and access review")}
      ...
      <div className="sq-grid" style={{ marginBlock: "var(--space-4)" }}>
        <section className="panel" style={{ padding: "var(--space-6)" }}><p className="t-caption">{t("mvp3.security.roleHoldings", "RLS-visible role holdings")}</p><strong className="kpi-value">{roleCount ?? 0}</strong><p>{t("mvp3.security.notPermission", "Holdings are not an effective-permission proof.")}</p></section>
