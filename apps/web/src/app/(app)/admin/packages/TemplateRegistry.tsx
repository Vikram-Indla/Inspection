...
function TemplateCard({ template, strings: s }: { template: TemplateRow; strings: TemplateStrings }) {
  ...
  return <details className="ax-panel" style={{ padding: "var(--space-4)" }}><summary><bdi dir="ltr">{template.template_key} · {template.version_label}</bdi> — {template.title_en} <span className="badge badge-info">{template.status}</span></summary>
