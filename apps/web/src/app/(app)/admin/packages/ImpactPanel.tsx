...
export default function ImpactPanel({ data, strings: s }: { data: ImpactData; strings: ImpactStrings }) {
  ...
  return (
    <div className="ax-panel ax-impact" style={{ padding: "var(--space-6)", display: "flex", flexDirection: "column", gap: "var(--space-6)", borderInlineStart: "4px solid var(--action-primary)" }}>
