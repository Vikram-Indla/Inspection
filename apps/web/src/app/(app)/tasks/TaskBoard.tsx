    ...
    <div className="panel stack">
      ...
      {task.canManage && (
        <div className="stack">
          ...
          <form action={reassignAction} className="row">
            ...
            {reassignState.error && <span className="badge badge-critical" role="alert">{reassignState.error}</span>}
          ...
          <form action={statusAction} className="row">
            <input type="hidden" name="task_id" value={task.id} />
            ...
            {statusState.error && <span className="badge badge-critical" role="alert">{statusState.error}</span>}
          ...
          <form action={activeAction} className="row">
            <input type="hidden" name="task_id" value={task.id} />
            ...
            {activeState.error && <span className="badge badge-critical" role="alert">{activeState.error}</span>}
