...
export async function WorkloadView({ basePath = "/visits" }: { basePath?: VisitBasePath }) {
  ...
  if (error) {
    ...
    return (
      <Shell current={basePath} title={t("visit.load.title", "Inspector workload")}>
  ...
  return (
    <Shell current={basePath} title={t("visit.load.title", "Inspector workload")}
      ...
      <VisitViewNavigation basePath={basePath} active="workload" ariaLabel={t("visit.views.aria", "Visit management views")}
