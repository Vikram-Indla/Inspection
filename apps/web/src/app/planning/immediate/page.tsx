...
export default async function Immediate() {
  ...
  const strings: ImmediateStrings = {
    ...
    windowHint: t("plan.imm.windowHint", "Leave blank for the urgent default — now to +8 hours (M01-047)"),
    priority: t("plan.imm.priority", "Priority (M01-047)"),
    priorityPlaceholder: t("plan.imm.priorityPlaceholder", "As set by your dispatch process — optional"),
