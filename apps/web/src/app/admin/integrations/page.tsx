  ...
  return (
    <Shell current="/admin/integrations" title={t("mvp3.integrations.title", "Integration trust console")}
      ...
      <section className="ax-surface ax-stack" style={{ padding: "var(--ax-space-300)" }} aria-labelledby="integration-registry">
        ...
        <div className="ax-tablewrap"><table className="ax-table"><thead><tr><th>{t("common.name", "Name")}</th><th>{t("common.type", "Type")}</th><th>{t("common.version", "Contract")}</th><th>{t("common.status", "Truth status")}</th></tr></thead><tbody>
