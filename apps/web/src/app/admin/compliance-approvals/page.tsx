...
export default async function ComplianceApprovalQueue({
  ...
  return (
    <Shell current="/admin/compliance-approvals" title="Compliance Approval Queue" context={<><span className="ax-lozenge ax-lozenge--info">CCR maker-checker</span><span className="t-caption">Distinct from Inspection Review &amp; Approval</span></>}>
      ...
      <div className="ccr-register-head"><div><h3>Review workload</h3><p className="t-caption">RLS-scoped requests are ordered by submitted time. Age is shown as a fact; no unapproved SLA or priority is inferred.</p></div><Link className="ax-btn ax-btn--secondary" href="/admin/compliance-requests">Request register</Link></div>
