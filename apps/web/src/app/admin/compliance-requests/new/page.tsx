...
export default function NewComplianceRequest() {
  return (
    <Shell current="/admin/compliance-requests" title="Create Compliance Configuration Request"
      ...
      <section className="ax-surface ccr-form-card" aria-labelledby="ccr-create-heading">
        ...
        <ActionForm action={createComplianceRequest} className="ccr-form" redirectOnCreate>
          <label className="ax-field"><span className="ax-field__label">Request type</span><select className="ax-select" name="request_type" required defaultValue="create"><option value="create">Create</option><option value="modify">Modify</option></select></label>
          <label className="ax-field"><span className="ax-field__label">Title</span><input className="ax-input" name="title" required maxLength={180} /></label>
          <label className="ax-field ccr-span"><span className="ax-field__label">Description</span><textarea className="ax-textarea" name="description" rows={4} /></label>
