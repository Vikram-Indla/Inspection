  ...
  return (
    <Shell current={shellCurrent} title={`${request.request_number} — ${request.title}`}
      ...
      <section className="ccr-grid" aria-label="Request components and dependencies">
        <div className="stack">
          <div className="ccr-section-heading"><div><h3>Components</h3><p className="t-caption">Current and proposed values are immutable after submission.</p></div><span className="badge">{currentComponents.length} in R{request.current_revision}</span></div>
