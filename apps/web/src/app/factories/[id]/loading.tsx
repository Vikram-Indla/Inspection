...
export default function Loading() {
  return (
    <div style={{ padding: "var(--ax-space-400)" }} role="status" aria-live="polite" aria-busy="true" aria-label="Loading factory profile">
      <SkeletonBlock blockSize={28} inlineSize="40%" style={{ marginBlockEnd: "var(--ax-space-200)" }} />
      <div className="cd-w3">
