...
export default async function VisitsCalendar() {
  ...
  return (
    <Shell current="/visits" title={t("visit.cal.title", "Visit calendar")}
      context={<span className="badge badge-info">{t("visit.cal.context", "M02-038 · RLS-scoped")}</span>}>
      <div className="row" role="group" aria-label={t("visit.views.aria", "Visit management views")}>
        ...
        <a className="btn btn-secondary btn-touch" aria-current="page" href="/visits/calendar">{t("visit.views.calendar", "Calendar")}</a>
