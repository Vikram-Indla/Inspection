...
export const SHELL_NAVIGATION: readonly ShellNavGroupDefinition[] = [
  ...
  },
  {
    ...
    items: [
      ...
      advancedAdmin({ id: "bulk-violations", labelKey: "shell.nav.bulkViolations", labelEn: "Bulk Violation Issuance", labelAr: "إصدار المخالفات الجماعي", href: "/admin/bulk-violations", icon: "enforcement", roles: ["ops", "compliance_admin"], businessTab: "Advanced Administration", parentId: "advanced-administration", parentLabelKey: "shell.nav.advancedAdministration", parentLabelEn: "Advanced Administration", parentLabelAr: "الإدارة المتقدمة" }),
      advancedAdmin({ id: "localization", labelKey: "shell.nav.localization", labelEn: "Localization", labelAr: "الترجمة", href: "/admin/localization", icon: "library", roles: ["compliance_admin", "security_admin", "workflow_admin"], businessTab: "Advanced Administration", parentId: "advanced-administration", parentLabelKey: "shell.nav.advancedAdministration", parentLabelEn: "Advanced Administration", parentLabelAr: "الإدارة المتقدمة" }),
