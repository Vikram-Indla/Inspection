...
export const VISIT_LIFECYCLE: WfPayload = {
  ...
  transitions: [
    ...
    t("submitted", "under_review", "route_review", "ops", undefined, ["assign"]),
    t("under_review", "approved", "approve", "reviewer"),
    t("under_review", "returned", "return", "reviewer"),
    t("returned", "in_progress", "rework", "assigned_inspector"),
    t("assigned", "cancelled", "cancel", "ops"),
    t("acknowledged", "cancelled", "cancel", "ops"),
    t("en_route", "cancelled", "cancel", "ops"),
    t("on_site", "cancelled", "cancel", "ops"),
    t("in_progress", "cancelled", "cancel", "ops"),
...
export const REPORT_LIFECYCLE: WfPayload = {
  ...
  transitions: [
    ...
    t("submitted", "qa_review", "route_qa", "ops"),
    t("qa_review", "returned", "return", "reviewer"),
    t("qa_review", "approved", "approve", "reviewer", ["signature_consent", "no_critical_sync_conflict"]),
    t("returned", "submitted", "resubmit", "assigned_inspector", ["report_mapping"]),
    t("approved", "shared", "share", "reviewer", ["signature_consent"]),
    t("shared", "archived", "archive", "ops"),
  ],
};
...
export const FINDING_LIFECYCLE: WfPayload = {
  ...
  transitions: [
    t("candidate", "confirmed", "confirm", "reviewer", ["evidence_required"]),
    t("confirmed", "violation_proposed", "propose_violation", "reviewer", ["clause", "severity"]),
    t("violation_proposed", "violation_approved", "approve_violation", "committee", ["clause", "due_date"], ["violation"]),
    t("violation_approved", "corrective_action_open", "open_action", "ops"),
    t("corrective_action_open", "closed", "close", "ops", ["evidence_required"]),
    t("corrective_action_open", "overdue", "mark_overdue", "ops"),
    t("overdue", "escalated", "escalate", "ops", undefined, ["notify"]),
    t("escalated", "closed", "close", "ops", ["evidence_required"]),
  ],
};
...
export const SELF_ASSESSMENT_LIFECYCLE: WfPayload = {
  ...
  transitions: [
    t("submitted", "compliance_review", "review", "compliance_admin", ["eligibility", "evidence_required"]),
    t("compliance_review", "accepted", "accept", "compliance_admin"),
    t("compliance_review", "rejected", "reject", "compliance_admin"),
    t("compliance_review", "returned", "return", "compliance_admin"),
    t("returned", "correction_action", "correct", "assigned_inspector"),
    t("correction_action", "verified", "verify", "compliance_admin", ["evidence_required", "sla"]),
    t("verified", "closed", "close", "compliance_admin"),
    t("accepted", "closed", "close_accepted", "compliance_admin"),
    t("rejected", "closed", "close_rejected", "compliance_admin"),
  ],
};
...
export const FORM_LIFECYCLE: WfPayload = {
  ...
  transitions: [
    t("draft", "review", "submit_review", "form_admin", ["bilingual_labels", "mappings"]),
    t("review", "field_pilot", "pilot", "form_admin", ["no_broken_logic"]),
    t("field_pilot", "approved", "approve", "form_admin", ["report_mapping"]),
    t("approved", "published", "publish", "form_admin", undefined, ["activate_form"]),
    t("published", "retired", "retire", "form_admin", ["successor"]),
  ],
};
...
export const RISK_MODEL_LIFECYCLE: WfPayload = {
  ...
  transitions: [
    t("draft", "simulated", "simulate", "risk_owner", ["valid_weights", "thresholds"], ["risk"]),
    t("simulated", "review", "submit_review", "risk_owner"),
    t("review", "approved", "approve", "risk_owner", ["maker_checker"]),
    t("approved", "scheduled", "schedule", "risk_owner"),
    t("scheduled", "published", "publish", "risk_owner", undefined, ["risk", "notify"]),
    t("published", "retired", "retire", "risk_owner", ["successor"]),
    t("published", "rolled_back", "rollback", "risk_owner"),
  ],
};
...
export const SYNC_LIFECYCLE: WfPayload = {
  ...
  transitions: [
    t("pending", "syncing", "start_sync", "ops", ["device_registered", "package_not_expired", "evidence_hash_valid"]),
    t("syncing", "synced", "complete", "ops"),
    t("syncing", "conflict", "conflict_detected", "ops"),
    t("syncing", "failed", "fail", "ops"),
    t("failed", "syncing", "retry", "ops"),
    t("conflict", "manually_resolved", "resolve", "ops", ["reason"]),
    t("failed", "manually_resolved", "manual_resolve", "ops", ["reason"]),
  ],
};
