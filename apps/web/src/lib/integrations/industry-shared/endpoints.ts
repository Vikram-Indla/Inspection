...
export const INDUSTRY_SHARED_ENDPOINTS = {
  ...
  job_workforce_info: lead("ISH-API-004", "job_workforce_info", "/shared/api/v2/job-workforce-info", "POST"),
  contact_list: lead("ISH-API-005", "contact_list", "/shared/api/v2/contact-list", "POST"),
  ...
  delegations: lead("ISH-API-010", "delegations", "/shared/api/v2/delegations", "POST"),
