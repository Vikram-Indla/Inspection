...
export default function PrintReport({ strings, backHref }: { strings: PrintReportStrings; backHref: string }) {
  return (
    <div className="ax-row no-print" style={{ justifyContent: "space-between", alignItems: "center", gap: "var(--ax-space-200)", padding: "var(--ax-space-200) var(--ax-space-300)" }}>
      <a className="ax-link" href={backHref}>← {strings.back}</a>
      <div className="ax-row" style={{ alignItems: "center", gap: "var(--ax-space-200)" }}>
