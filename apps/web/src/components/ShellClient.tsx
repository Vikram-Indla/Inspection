        ...
        <>
          ...
          <nav ref={navRef} id="saqeel-primary-nav" className="sq-shell__nav" aria-label={strings.primary}>
            <div className="sq-shell__brand">
              <img className="sq-shell__brand-mark" src="/saqeel-favicon.svg" alt="" aria-hidden="true" />
              <span className="sq-shell__brand-lockup">
                <img className="sq-shell__brand-wordmark" src="/saqeel-wordmark-dark-mode.svg" alt="SAQEEL | صقيل" />
              </span>
