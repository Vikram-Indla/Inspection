...
export async function AppShell({ children }: { children: ReactNode }) {
  ...
  const shellStrings: ShellClientStrings = {
    ...
    admin: {
      ...
      brandLabel: t("admin.shell.brandLabel", "Inspection Platform | منصة التفتيش"),
      brandArabic: t("admin.shell.brandArabic", "منصة التفتيش"),
      brandEnglish: t("admin.shell.brandEnglish", "Inspection Platform"),
