    ...
    <div ref={wrapRef} className="sq-notification">
      ...
      {open && popoverPos && typeof document !== "undefined" && createPortal(
        <div ref={popoverRef} className="sq-popover" role="dialog" aria-label={strings.heading}
          style={{ position: "fixed", top: popoverPos.top, left: popoverPos.left, right: popoverPos.right, inlineSize: 360, maxInlineSize: "80vw", zIndex: 30, display: "flex", flexDirection: "column", gap: "var(--sq-space-100)" }}>
