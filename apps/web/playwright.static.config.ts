...
export default defineConfig({
  testDir: "./e2e",
  testMatch: /(compliance-approval-queue|compliance-library|compliance-request-engine|compliance-shared-shell|design-foundation-contract|platform-design-system-contract|inspector-shell-uplift|ui-compliance-contract|ipad-gps-policy|mvp2-m2-05-contract|mvp2-m2-02-events|mvp2-m2-04-risk-model|mvp2-m2-08-portal|mvp2-m2-09-exceptions|mvp2-m2-10-cases|mvp2-m2-11-ai|mvp2-m2-12-signature|mvp2-m2-06-spatial|mvp2-shared-0193|mvp2-email-resend|mvp2-ai-gemini|mvp2-sms-twilio|mvp2-signature-docusign|mvp3-enterprise-contract|ai-delta-contract|ocr-journey-contract|senaei-integration-contract|industry-shared-integration-contract|factory360-admin-control-plane|factory360-cr-dossier-contract|factory360-cross-provider-contract|factory360-ipad-field)\.spec\.ts/,
