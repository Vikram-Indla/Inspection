...
AR = {
  ...
  "admin.shell.paletteOpen": "فتح أدوات الإدارة",
  "admin.shell.paletteGoTo": "الانتقال إلى أداة إدارية",
  "admin.shell.paletteSearch": "ابحث في أدوات الإدارة المسموح بها",
  "admin.shell.paletteResultsOne": "{count} نتيجة مسموح بها",
  "admin.shell.paletteResultsOther": "{count} نتيجة مسموح بها",
  "admin.shell.paletteEmpty": "لا توجد أدوات مطابقة",
