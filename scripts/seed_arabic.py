...
AR = {
  ...
  "landing.nav.ipad": "آيباد", "landing.nav.agent": "الوكيل",
  "landing.cta.workspace": "افتح مساحة عملك", "landing.cta.signin": "تسجيل الدخول",
  ...
  "landing.hero.ctaWorkspace": "افتح مساحة عملك", "landing.hero.ctaSignin": "سجّل الدخول إلى قناتك",
  ...
  "landing.persona.inspector.title": "المفتش · آيباد",
  ...
  "login.inspector.title": "المفتش — آيباد", "login.inspector.short": "آيباد",
