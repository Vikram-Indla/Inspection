...
# CLAUDE_CODE_HANDOFF_CD-004_R2.md
...
1. IMPLEMENTATION_MANIFEST_CD-004_R2.yaml — confirm implementation_authorized has been flipped to true by the sponsor; otherwise STOP.
2. "CD-004 Admin Control Plane Home R2.dc.html" (selected hypothesis A; frames r2e-r2n).
3. DATA_TRUTH_LEDGER_CD-004_R2.csv — every visible value's exact source; nothing outside it may render.
4. WIRING_MAP_CD-004_R2.csv, STATE_MATRIX_CD-004_R2.md, ACCESSIBILITY_KEYBOARD_SPEC_CD-004_R2.md, COMPONENT_MAP_CD-004_R2.md, LOCALIZATION_INVENTORY_CD-004_R2.csv, ROLE_ROUTE_VISIBILITY_MATRIX_CD-004_R2.csv, ACCEPTANCE_CHECKLIST_CD-004_R2.md.
