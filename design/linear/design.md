...
> **⚠️ PALETTE SUPERSEDED (amendment).** This document is a captured reference of
> Linear's own system, kept verbatim. In SAQEEL its **structure** still governs —
> hairline elevation, the 400–510 type band, tight tracking, 6/12px radii,
> compact spacing. Its **colour does not**: the acid-lime accent (`#e4f222`) and
> the near-black brand surfaces were retired and replaced by the **IRP palette**
> (aubergine brand `#413259`/`#7E61AC`, IRP greys, IRP status). Where this file
> says acid lime, primary-action colour, or a brand surface hue, read the IRP
> value in `apps/web/src/app/saqeel.css`. Authority: WEB-002 header + §1/§7.
> Everything below is the unmodified reference.
