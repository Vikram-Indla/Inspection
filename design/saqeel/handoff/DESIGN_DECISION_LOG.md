...
|---|---|---|---|
| D1 | 20 Jul 2026 | Industry = structural reference only; Nocturne = dark-mode reference only; no third template | preserve original identity |
| D2 | 20 Jul 2026 | Typography: IBM Plex Sans / IBM Plex Sans Arabic / IBM Plex Mono (identifiers only); Barlow banned | bilingual institutional identity |
| D3 | 20 Jul 2026 | One emerald action colour; 10 fixed status roles; colour never decorative | quiet confidence, semantic colour |
| D4 | 20 Jul 2026 | Emerald deepened #146b50 → #115c44 (light); dark stays #2e9e77 | institutional weight, map recession, ~7:1 on white |
