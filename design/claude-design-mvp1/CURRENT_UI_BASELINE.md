...
- Type: retired input font for English, IBM Plex Sans Arabic for Arabic, retired mono font for identifiers and operational telemetry.
...
- Existing design prototypes: `design/retired-predecessor/` D1–D9.
...
5. Older Fable/retired predecessor prompts conflict on Mobbin. Pattern research is permitted by DEC-011, but copying is prohibited.
